...
//        Toast.makeText(getApplicationContext(), "" + dbData, Toast.LENGTH_LONG).show();
        ...
        for (int i = 0; i < packages.length; i++){
            ...
            item.put("lin1", packages[i][0]);
            item.put("lin2", packages[i][1]);
            item.put("lin3", packages[i][2]);
            item.put("lin4", packages[i][3]);
            item.put("lin5", packages[i][4]);
            list.add(item);
        }

        sa = new SimpleAdapter(this, list,
                R.layout.multi_lines,
                new String[] {"line1", "line2", "line3", "lime4", "line5"},
                new int[] {R.id.line_a, R.id.line_b, R.id.line_c, R.id.line_d, R.id.line_e, R.id.line_e});
        lst.setAdapter(sa);
